    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h5 class='mb-0'>List Log Mitra</h5>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id='tabelListLogMitra' class='table table-sm'>
                        <thead>
                            <tr>
...
<script language='Javascript'>
    let _tabelListLogMitraEl    =   $('#tabelListLogMitra');
    let _getListLog             =   `<?=site_url(mitraController('log/get-list-log'))?>`;
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    return `<h6 class='mb-1'>${_judul}</h6>
                            ...
                            <span class='text-sm'>Oleh <b>${_namaMitra}</b> pada <b>${convertDateTime(_createdAt)}</b></span>`;
                }
            },
            {
                data: null,
    ...
    let _tabelListLogMitra = _tabelListLogMitraEl.DataTable(_tableListBroadcastOptions);
</script>