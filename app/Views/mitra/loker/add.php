                    ...
                    <div class="col-lg-8">
                        ...
                        <?php }else{ ?>
                            <div class="alert alert-warning text-sm">
                                Mohon maaf, anda tidak memiliki paket aktif. Untuk bisa memposting lowongan pekerjaan, silahkan order paket terlebih dahulu melalui link <a class='text-primary' href="<?=site_url(mitraController('transaksi/pilihan-paket'))?>">ini</a>.
                                <br />
                                Atau jika anda memiliki transaksi pending (transaksi yang belum diselesaikan) segera selesaikan transaksi tersebut.
                            </div>
                        <?php } ?>
                    </div>
                </div>
