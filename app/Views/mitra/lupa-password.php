...
<head>
    ...
    <title>Mitra | Lupa Password</title>
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body py-4">
                ...
                <form id='formLupaPassword' method='post' action='<?= site_url(mitraController('lupa-password')) ?>' onSubmit='_formLupaPasswordSubmit(this, event)'>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-center mb-0 mt-3">
                                <a href="<?= site_url(mitraController('login')) ?>">Login</a>
                            </p>
                        </div>
                    </div>
                </form>
