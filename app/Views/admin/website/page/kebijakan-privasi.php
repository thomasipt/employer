<?php
    $kebijakanPrivasiElement    =   $data['kebijakanPrivasiElement'];
?>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
                            ...
                            <div class="col col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea class='form-control' placeholder='Content' required
                                        name='_content' id='_content'><?=(!empty($kebijakanPrivasiElement))? $kebijakanPrivasiElement['_content'] : '' ?></textarea>
                                </div>
...
<script language='Javascript'>
    let _formKebijakanPrivasi       =   $('#formKebijakanPrivasi');
    ...
    _formKebijakanPrivasi.on('submit', async function(e){
        e.preventDefault();
        ...
        await submitForm(this, async (decodedRFS) => {
            ...
            let _title  =   'Kebijakan Privasi';
            let _type   =   (_status)? 'success' : 'error';

            await notifikasi(_title, _message, _type);
            if(_status){
                location.href   =   `<?=site_url(adminController('website/page/kebijakan-privasi'))?>`;
            }
        })
    });
</script>