    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body py-4">
                ...
                <p class="login-box-msg mt-3">Dashboard Administrator</p>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-center mb-0 mt-3">
                                <a href="<?=site_url(adminController('lupa-password'))?>">Lupa Password</a>
                            </p>
                        </div>
                        <!-- /.col -->
                    </div>
...
<script language='Javascript'>
    ...
    _formLogin.on('submit', function(e){
        ...
        $.ajax({
            url     :   `<?=site_url(adminController('auth-process'))?>`,
            type    :   'POST',
            data    :   _formData,
            success :   async (decodedRFS) => {
                ...
                if(_status){
                    location.href   =   `<?=site_url(adminController())?>`;
                }else{
